const MESSAGE_LIBRARY = {
  ...
  withdrawInvalidCard: {
    ...
    message: "لطفاً شماره کارت ۱۶ رقمی معتبری را وارد کنید.",
    hint: "شماره کارت را بدون کاراکتر اضافی و با ارقام صحیح ثبت کنید.",
    type: "error",
  },
  withdrawInvalidIban: {
    title: "شماره شبای نامعتبر",
    message: "شماره شبا باید با IR آغاز شده و ۲۶ کاراکتر داشته باشد.",
    hint: "شماره شبا را بدون فاصله یا خط تیره و با حروف بزرگ وارد کنید.",
    type: "error",
  },
  withdrawValidationFailed: {
    title: "خطا در بررسی اطلاعات برداشت",
    message: "اطلاعات ارسال شده برای برداشت معتبر نیست.",
    hint: "پیام خطا را بررسی کرده و سپس دوباره تلاش کنید.",
    type: "error",
  },
  depositFailed: {
